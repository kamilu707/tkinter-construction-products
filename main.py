...
menu5 = Button(F1, width=88, bg='#EFEAD8', bd=1, relief=SOLID, cursor='hand2', height=85, image=img_menu5, text='عربة' , compound=TOP )
...
menu7 = Button(F1, width=88, bg='#EFEAD8', bd=1, relief=SOLID, cursor='hand2', height=85, image=img_menu7, text='سلم' , compound=TOP )
menu7.place(x=310, y=180)


menu8 = Button(F1, width=88, bg='#EFEAD8', bd=1, relief=SOLID, cursor='hand2', height=85, image=img_menu8, text='قبعة سلامة' , compound=TOP )
...
sb2 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb2.place(x=170, y=140)
sb.append(sv2)

sb3 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb3.place(x=310, y=140)
sb.append(sv3)

sb4 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb4.place(x=450, y=140)
sb.append(sv4)

sb5 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb5.place(x=30, y=275)
sb.append(sv5)

sb6 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb6.place(x=170, y=275)
sb.append(sv6)

sb7 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb7.place(x=310, y=275)
sb.append(sv7)

sb8 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb8.place(x=450, y=275)
sb.append(sv8)

sb9 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb9.place(x=30, y=415)
sb.append(sv9)

sb10 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb10.place(x=170, y=415)
sb.append(sv10)

sb11 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb11.place(x=310, y=415)
sb.append(sv11)

sb12 = Spinbox(F1, from_=0, to_=5, font=font1, width=10, textvariable=sv1 )
sb12.place(x=450, y=415)
sb.append(sv12)

#============ Buttons =============
b1= Button(F1, text='شراء المواد', fg='white', font=('Tajawal 12'), width=15, bg='#6D8B74', bd=1, relief=SOLID, cursor='hand2',height=1)
b1.place(x=30, y=500)
